  ...
  coldefsoption: any = [[
    ...
    },
    {
      ...
      cellStyle: (params: { value: string; }) => {
        ...
        return {
            borderRight: '0.5px solid rgba(0, 0, 0, 0.3)', // Reduced opacity for right border
          borderTop: '0.5px solid transparent', // Optional: no border at the top
          borderBottom: '0.5px solid transparent', // Optional: no border at the bottom
        };
      },
      field: 'matname',
